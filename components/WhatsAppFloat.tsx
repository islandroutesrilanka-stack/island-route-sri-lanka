  ...
  return (
    ...
    >
      <a
        ...
        className="animate-pulse-soft flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl ring-1 ring-deep/20 transition-transform duration-200 ease-out hover:scale-[1.08] active:scale-[0.94]"
      >
