...
export default function BookingForm({
    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="mt-7 inline-flex items-center gap-2.5 bg-wa text-white px-7 py-3.5 text-[13px] uppercase tracking-[0.16em] hover:bg-wa-dark transition-colors"
        >
  ...
  return (
    <form onSubmit={submit} className="relative space-y-5" noValidate={false}>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div>
          <label className="eyebrow text-ink/65 block mb-2" htmlFor="bf-service">
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-2">
        <motion.button
          ...
          type="submit"
          disabled={pending}
          className="flex items-center justify-center gap-2.5 bg-ink text-sand px-8 py-4 text-[13px] uppercase tracking-[0.16em] hover:bg-copper-deep transition-colors disabled:opacity-60"
        >
          {pending ? (
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className="flex items-center justify-center gap-2.5 bg-wa text-white px-8 py-4 text-[13px] uppercase tracking-[0.16em] hover:bg-wa-dark transition-colors"
        >
      ...
      {state === "error" && (
        <p className="text-sm text-copper-deep pt-1">
          {error || "Something went wrong saving your request"} — please use the
          WhatsApp button instead, or email us directly at{" "}
