...
export const posts: Post[] = [
  {
    ...
    sections: [
      ...
      { heading: "Days 8–9: Safari and the south", body: "Drop out of the hills to Yala for a dawn game drive — the world's best odds of a wild leopard sighting — then follow the coast west through Tangalle and Mirissa. In season, a blue whale excursion is unforgettable." },
