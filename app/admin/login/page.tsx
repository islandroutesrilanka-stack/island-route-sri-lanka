      ...
      >
        ...
        {!sb ? (
          <div className="mt-8 border border-copper/40 bg-copper/10 p-5 text-sm leading-relaxed text-sand/80">
            <p className="font-semibold text-sand mb-2">Backend not connected yet</p>
            <p>
              Add your Supabase keys to <code className="bg-deep/60 px-1.5 py-0.5">.env.local</code>{" "}
              and restart the server. Full instructions are in{" "}
          ...
          <form onSubmit={submit} className="mt-8 space-y-4">
            <div>
              <label className="eyebrow text-sand/50 block mb-1.5" htmlFor="al-email">
                Email
              </label>
              <input
                id="al-email"
            ...
            <div>
              <label className="eyebrow text-sand/50 block mb-1.5" htmlFor="al-pass">
                Password
              </label>
              <input
                id="al-pass"
